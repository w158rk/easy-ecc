...
*/
uint8_t ecc_make_key(uint8_t p_publicKey[ECC_BYTES+1], uint8_t p_privateKey[ECC_BYTES]);
...
*/
uint8_t ecdh_shared_secret(const uint8_t p_publicKey[ECC_BYTES+1], const uint8_t p_privateKey[ECC_BYTES], uint8_t p_secret[ECC_BYTES]);

uint8_t ecdsa_sign(uint8_t *signature, const uint8_t p_privateKey[ECC_BYTES], 
 ...
 */
uint8_t ecc_encrypt(uint8_t **c, size_t *c_len, uint8_t *m, size_t m_len, uint8_t *key);
 ...
 */
uint8_t ecc_decrypt(uint8_t **m, size_t *m_len, uint8_t *c, size_t c_len, uint8_t *key);
