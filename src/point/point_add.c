...
void XYcZ_add(uint64_t *X1, uint64_t *Y1, uint64_t *X2, uint64_t *Y2)
{
    ...
    vli_modMult_fast(t5, t5, t5);      /* t5 = (x2 - x1)^2 = A */
    ...
    vli_modMult_fast(t5, t4, t4);      /* t5 = (y2 - y1)^2 = D */
...
void XYcZ_addC(uint64_t *X1, uint64_t *Y1, uint64_t *X2, uint64_t *Y2)
{
    ...
    vli_modMult_fast(t3, t4, t4);      /* t3 = (y2 - y1)^2 */
    ...
    vli_modMult_fast(t7, t5, t5);      /* t7 = (y2 + y1)^2 = F */
